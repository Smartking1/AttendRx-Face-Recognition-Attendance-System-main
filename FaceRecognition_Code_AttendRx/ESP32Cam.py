...
esp32cam_url = 'http://192.168.232.70/cam-mid.jpg'
...
def markAttendance(name):
    with open('C:/Users/hp/Downloads/AttendRx-Face-Recognition-Attendance-System-main/FaceRecognition_Code_AttendRx/Attendance.csv~', 'r+') as f:
